	...
	class Functions
	{
		...
		public function uploadImage($file='', $extension='', $folder='', $newname='')
		{
			...
			if(isset($_FILES[$file]) && !$_FILES[$file]['error'])
			{
				...
				$MaxSize = $MaxSize[0];
				if($_FILES[$file]['size'] > (double)$MaxSize*1048576)
				{
	    ...
	    public function phantram($gia,$giam)
		{
			$ketqua = ($gia - $giam)/($gia);
	    ...
	    public function get_product($array,$class,$com){ 
			global $lang;
			?>
		            ...
		            <div class="product transition">
		                <a href="<?=$v['tenkhongdauvi']?>">
		                	<div class="product_img">
			                    <img class="transition w-100" onerror="this.src='<?=THUMBS?>/285x230x1/assets/images/noimage.png';" alt="<?=$v['ten'.$lang]?>" src="<?=THUMBS?>/285x230x1/<?=UPLOAD_PRODUCT_L.$v['photo']?>">
			                </div>
		                    <div class="ten-product transition">
		                        <h3><?=$v['ten'.$lang]?></h3>
		                    </div>
		                    <div class="gia-product">
		                    	Giá:<span><?=(isset($v['gia']) && $v['gia']!=0 ) ? $this->format_money($v['gia']) : 'Liên hệ'?></span>
		                    </div>
		                </a>
		            </div> 
		        </div>              
		...
		<?php }
		public function get_product_owl($array,$class,$class_owl,$com){ 
			global $lang;
			?>
			<div class="owl-carousel owl-theme <?=$class_owl?>"> 
			<?php 	foreach($array as $v){ ?>
				<div class="item">
		            <div class="product transition <?=$class?>">
		                <a href="<?=$v['tenkhongdauvi']?>">
		                	<div class="product_img">
			                    <img class="transition w-100" onerror="this.src='<?=THUMBS?>/285x230x1/assets/images/noimage.png';" alt="<?=$v['ten'.$lang]?>" src="<?=THUMBS?>/285x230x1/<?=UPLOAD_PRODUCT_L.$v['photo']?>">
			                </div>
		...
		<?php }
		public function get_dichvu($array,$class,$com){ 
			global $lang;
			?>
			<div class="row"> 
			<?php 	foreach($array as $v){ ?>
				<div class="col-md-6 col-12 col-sm-6">
		            <a class="news text-decoration-none w-clear" href="<?=$v['tenkhongdauvi']?>" title="<?=$v['ten'.$lang]?>">
			            <p class="pic-news scale-img"><img onerror="this.src='<?=THUMBS?>/160x120x2/assets/images/noimage.png';" src="<?=THUMBS?>/160x120x2/<?=UPLOAD_NEWS_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>"></p>
			            <div class="info-news">
		...
		<?php }
		public function get_project($array,$class,$com){ 
			global $lang;
			?>
			<div class="row"> 
			<?php 	foreach($array as $v){ ?>
				<div class="col-md-4 col-12 col-sm-6">
		            <a class="project text-decoration-none w-clear" href="<?=$v['tenkhongdauvi']?>" title="<?=$v['ten'.$lang]?>">
			            <p class="pic-project scale-img"><img class="w-100" onerror="this.src='<?=THUMBS?>/385x250x1/assets/images/noimage.png';" src="<?=THUMBS?>/385x250x1/<?=UPLOAD_NEWS_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>"></p>
			            <div class="info-project">
			                <h3 class="name-project"><?=$v['ten'.$lang]?></h3>
			                <p class="desc-project text-split"><?=$v['mota'.$lang]?></p>
			            </div>
			        </a>
		        </div>              
				<?php } ?>
		...
		<?php }
		public function get_banggia($array,$class,$com){ 
			global $lang;
			?>
			<div class="row"> 
			<?php 	foreach($array as $v){ ?>
				<div class="col-md-4 col-12 col-sm-6">
		            <a class="banggia_home-normal text-decoration-none w-clear" href="<?=$v[$sluglang]?>" title="<?=$v['ten'.$lang]?>">
						<div class="info-banggia_home-normal">
							<div class="flex-in">
								<h3 class="name-banggia_home text-split"><?=$v['ten'.$lang]?></h3>
								<p class="desc-banggia_home text-split"><?=htmlspecialchars_decode($v['mota'.$lang])?></p>
								<p class="link-banggia_home text-split"><img src="assets/images/ic-xt.png" alt="">XEM THÊM</p>
							</div>
						</div>
					</a>
		        </div>              
		...
		<?php }
		public function get_news($array,$class,$com){ 
			global $lang;
			?>
			<div class="row"> 
			<?php 	foreach($array as $v){ ?>
				<div class="col-md-6 col-12 col-sm-6">
		            <a class="news text-decoration-none w-clear" href="<?=$v['tenkhongdauvi']?>" title="<?=$v['ten'.$lang]?>">
			            <p class="pic-news scale-img"><img onerror="this.src='<?=THUMBS?>/160x120x1/assets/images/noimage.png';" src="<?=THUMBS?>/160x120x1/<?=UPLOAD_NEWS_L.$v['photo']?>" alt="<?=$v['ten'.$lang]?>"></p>
			            <div class="info-news">
			                <h3 class="name-news"><?=$v['ten'.$lang]?></h3>
