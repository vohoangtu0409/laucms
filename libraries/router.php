<?php
	...
	$requick = array(
		...
		array("tbl"=>"tags","tbltag"=>"news","field"=>"id","source"=>"tags","com"=>"tags-cong-trinh","type"=>"cong-trinh",'menu'=>true),
		array("tbl"=>"tags","tbltag"=>"news","field"=>"id","source"=>"tags","com"=>"tags-dich-vu","type"=>"dich-vu",'menu'=>true),
		array("tbl"=>"tags","tbltag"=>"news","field"=>"id","source"=>"tags","com"=>"tags-bao-gia","type"=>"bao-gia",'menu'=>true),
	...
	switch($com)
	{
		...
		case 'cong-trinh':
			$source = "news";
			$template = isset($_GET['id']) ? "news/news_detail" : "news/congtrinh";
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
