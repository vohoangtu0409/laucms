...
<head>
	...
	<script type="text/javascript">
		CKEDITOR.editorConfig = function( config ) {
			...
			/* All Plugins */
			config.extraPlugins = 'texttransform,copyformatting,html5video,html5audio,flash,youtube,wordcount,tableresize,widget,lineutils,clipboard,dialog,dialogui,widgetselection,lineheight,video,videodetector,codemirror';
