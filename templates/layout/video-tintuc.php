					...
					<div class="row">
						<div class="col-md-6 col-12">
							<a class="newshome-best text-decoration-none" href="<?=$newsnb[0][$sluglang]?>" title="<?=$newsnb[0]['ten'.$lang]?>">
								<p class="pic-newshome-best scale-img"><img class="w-100" onerror="this.src='<?=THUMBS?>/370x200x1/assets/images/noimage.png';" src="<?=WATERMARK?>/news/370x200x1/<?=UPLOAD_NEWS_L.$newsnb[0]['photo']?>" alt="<?=$newsnb[0]['ten'.$lang]?>"></p>
