            ...
            <div class="wrap-cart d-flex align-items-stretch justify-content-between">
                ...
                <div class="top-cart">
                    ...
                    <div class="list-procart">
                        ...
                        $proinfo = $cart->get_product_info($pid,$size);
                        ...
                        <div class="procart procart-<?=$code?> d-flex align-items-start justify-content-between">
                            ...
                            <div class="info-procart">
                                <h3 class="name-procart"><a class="text-decoration-none" href="<?=$proinfo[$sluglang]?>" target="_blank" title="<?=$proinfo['ten'.$lang]?>">
                                        <?=$proinfo['ten'.$lang]?></a></h3>
                            ...
                            <div class="quantity-procart">
                                ...
                                <div class="quantity-counter-procart quantity-counter-procart-<?=$code?> d-flex align-items-stretch justify-content-between">
                                    ...
                                    <input type="number" class="quantity-procat" min="1" value="<?=$quantity?>" data-pid="<?=$pid?>" data-code="<?=$code?>" data-sid="<?=$size?>"/>
                    ...
                    <div class="money-procart">
                        ...
                        <div class="total-procart d-flex align-items-center justify-content-between">
                            ...
                            <p class="total-price load-price-temp">
                                <?=$func->format_money($cart->get_order_total())?>
                            </p>
                        </div>
                        <?php } ?>
                        <?php if($config['order']['ship']) { ?>
                    ...
                    <div class="section-cart">
                        ...
                        <div class="information-cart">
                            ...
                            <div class="payments-cart custom-control custom-radio">
                                ...
                                <label class="payments-label custom-control-label" for="payments-<?=$value['id']?>" data-payments="<?=$value['id']?>">
                                    <?=$value['ten'.$lang]?></label>
